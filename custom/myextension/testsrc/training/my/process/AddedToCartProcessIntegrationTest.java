...
@IntegrationTest
public class AddedToCartProcessIntegrationTest extends ServicelayerTest {
    ...
    final private String IMPEX_FILE_PATH = "C:\\Users\\Dmitriy\\hybris-commerce\\hybris\\bin\\custom\\myextension\\testsrc\\training\\my\\process\\addedToCartTest.impex";
    ...
    public void testOnEvent() {
        ...
        //BusinessProcessEvent event = BusinessProcessEvent.builder("event").withChoice("CartEntryRemoval").build();
        //businessProcessService.triggerEvent(event);

        cartService.saveOrder(cartModel);
        //businessProcessService.triggerEvent(cartEntryModel.getPk().toString() + "_addedToCart_Ordered");
        BusinessProcessEvent event = BusinessProcessEvent.builder("event").withChoice("Ordered").build();
        businessProcessService.triggerEvent(event);
