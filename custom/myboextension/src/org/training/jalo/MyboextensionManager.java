...
import org.training.constants.MyboextensionConstants;
 ...
 */
public class MyboextensionManager extends GeneratedMyboextensionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MyboextensionManager.class.getName());
	 ...
	 */
	public static MyboextensionManager getInstance()
	{
		return (MyboextensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MyboextensionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MyboextensionManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MyboextensionManager called.");
		}
	}
